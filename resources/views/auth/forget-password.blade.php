							...
							<div class="row justify-content-center">
								<div class="col-md-7 col-lg-5">
									<div class="card">
										...
										<form class="card-body pt-3" action="{{ route('auth.forgot-password.post') }}" method="POST">
											<div class="form-group">
												<label class="form-label">E-Mail</label>
												<input class="form-control" name="email" placeholder="Nhập email của bạn" type="text">
											</div>
											<div class="submit">
												<button type="submit" class="btn btn-primary btn-block">Lấy lại mật khẩu</button>
											</div>
											<div class="text-center mt-4">
												<p class="text-dark mb-0">Trở lại?<a class="text-primary ml-1" href="{{ route('auth.login') }}">đăng nhập</a></p>
											</div>
										</form>
									</div>
								</div>
