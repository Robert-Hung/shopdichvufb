							...
							<div class="row justify-content-center">
								<div class="col-md-7 col-lg-5">
									<div class="card">
										...
										<form class="card-body pt-3" action="{{ route('auth.register.post') }}" method="POST">
											<div id="callback"></div>
											<div class="form-group">
												<label class="form-label">Họ và tên</label>
												<input class="form-control form-control-lg" name="name" placeholder="Nhập họ tê của bạn" type="Text" value="{{ old('name') }}">
											</div>
											<div class="form-group">
												<label class="form-label">Email</label>
												<input class="form-control form-control-lg" name="email" placeholder="Nhập email của bạn" type="text" value="{{ old('email') }}">
											</div>
											<div class="form-group">
												<label class="form-label">Tên đăng nhập</label>
												<input class="form-control form-control-lg" name="username" placeholder="Nhập tên đăng nhập của bạn" type="text" value="{{ old('username') }}">
											</div>
											<div class="form-group">
											...
											<div class="submit">
												<button type="submit" callback="rescallback" class="btn btn-primary btn-lg btn-block">Đăng kí</button>
											</div>
											<div class="text-center mt-4">
												<p class="text-dark mb-0">Bạn đã có tài khoản?<a class="text-primary ml-1" href="{{ route('auth.login') }}">Đăng nhập</a></p>
											</div>
										</form>
									</div>
								</div>
