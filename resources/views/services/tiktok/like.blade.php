            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <a href="{{ route('service.tiktok.order', 'like') }}" class="btn btn-outline-primary btn-block">Lịch sử</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form request-ajax="lbd" action="{{ route('service.tiktok.like.post') }}" method="POST">
                        <div id="msg"></div>
