...
@section('content')
    ...
    <div class="page-header d-xl-flex d-block">
        <div class="page-leftheader">
            <h5 class="page-title"><span class="font-weight-normal text-muted ml-2">{{ $title }}</span></h5>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <a href="{{ route('service.tiktok.order', 'comment') }}" class="btn btn-outline-primary btn-block">Lịch sử</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form request-ajax="lbd" action="{{ route('service.tiktok.comment.post') }}" method="POST">
                        <div id="msg"></div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-3">
                                    <label for="link_post" class="form-label">Link video</label>
                                </div>
                                <div class="col-9">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <textarea name="comment" class="form-control" id="camxuc" cols="15" rows="3" placeholder="Nhập nội dung mỗi dội dung 1 dòng"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <textarea name="note" id="ghichu" cols="15" rows="3" placeholder="Nhập ghi chú nếu cần" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
