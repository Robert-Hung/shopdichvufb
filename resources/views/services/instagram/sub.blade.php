...
@section('content')
    ...
    <div class="page-header d-xl-flex d-block">
        <div class="page-leftheader">
            <h5 class="page-title"><span class="font-weight-normal text-muted ml-2">{{ $title }} - Instagram</span></h5>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <a href="{{ route('service.instagram.order', 'sub') }}" class="btn btn-outline-primary btn-block">Lịch sử</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form request-ajax="lbd" action="{{ route('service.instagram.sub.post') }}" method="POST">
                        <div id="msg"></div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-3">
                                    <label for="link_post" class="form-label">Username</label>
                                </div>
                                <div class="col-9">
