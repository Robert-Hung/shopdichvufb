        ...
        <div class="">
            <div class="card">
                <div class="card-header border-bottom-0">
                    <div class="row">
                        <div class="col-xl-6">
                            <a href="{{ url('service/instagram') }}/{{ $title }}/buy" class="btn btn-outline-primary">Thêm đơn</a>
                        </div>
                        <div class="col-xl-6">
                            <a href="{{ route('service.instagram.order', $title) }}" class="btn btn-primary btn-block">Lịch sử</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
