            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <a href="#" class="btn btn-outline-primary btn-block">Lịch sử</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form request-ajax="lbd" action="{{ route('service.facebook-v2.eye-live.post') }}" method="POST">
                        <div id="msg"></div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-3">
                                    <label for="link_post" class="form-label">ID Bài viết</label>
                                </div>
                                <div class="col-9">
                                    <input type="text" class="form-control" id="link_post" name="link_post"
                                        placeholder="Nhập link facebook của bạn hoặc id facebook của bạn">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-3">
                                    <label for="eye_amount" class="form-label">Số mắt</label>
                                </div>
                                <div class="col-9">
                                    <input type="number" value="50" class="form-control" id="eye_amount" name="eye_amount"
                                        placeholder="Nhập số mắt">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-3">
                                    <label for="amount" class="form-label">Số phút</label>
                                </div>
                                <div class="col-9">
