            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <a href="{{ route('service.facebook-v2.order', 'like-page-quality') }}" class="btn btn-outline-primary btn-block">Lịch sử</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form request-ajax="lbd" action="{{ route('service.facebook-v2.like-page-quality.post') }}" method="POST">
                        <div id="msg"></div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <input type="number" name="amount" id="amount" value="100" class="form-control">
                                    <div class="mt-5">
