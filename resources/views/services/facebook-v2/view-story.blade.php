            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <a href="{{ route('service.facebook-v2.order', 'view-story') }}" class="btn btn-outline-primary btn-block">Lịch sử</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form request-ajax="lbd" action="{{ route('service.facebook-v2.view-story.post') }}" method="POST">
                        <div id="msg"></div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-3">
                                    <label for="link_post" class="form-label">Link story</label>
                                </div>
                                <div class="col-9">
                                    <input type="text" class="form-control" id="link_post" name="link_post"
                                        placeholder="Nhập link story cần tăng">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
