        ...
        <div class="col-lg-6 col-xl-8">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-xl-6">
                            <a href="{{ route('service.facebook-v2.like-post-speed') }}" class="btn btn-primary btn-block">Thêm đơn</a>
                        </div>
                        <div class="col-xl-6">
                            <a href="{{ route('service.facebook-v2.order', 'like-post-speed') }}" class="btn btn-outline-primary btn-block">Lịch sử</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form request-ajax="lbd" action="{{ route('service.facebook-v2.like-post-speed.post') }}" method="POST">
                        <div id="msg"></div>
                        ...
                        <div class="form-group" id="type_reaction">
                            <div class="row">
                                <div class="col-3">
                                    <label for="camxuc" class="form-label">Cảm xúc</label>
                                </div>
                                <div class="col-9">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label" for="reaction0">
                                            <input class="form-check-input" type="radio" id="reaction0" name="reaction" value="like">
                                            <span class="">Like</span>
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label" for="reaction1">
                                            <input class="form-check-input" type="radio" id="reaction1" name="reaction" value="love">
                                            <span class="">Thả tim</span>
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label" for="reaction2">
                                            <input class="form-check-input" type="radio" id="reaction2" name="reaction" value="care">
                                            <span class="">Thương thương</span>
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label" for="reaction3">
                                            <input class="form-check-input" type="radio" id="reaction3" name="reaction" value="haha">
                                            <span class="">Haha</span>
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label" for="reaction4">
                                            <input class="form-check-input" type="radio" id="reaction4" name="reaction" value="wow">
                                            <span class="">Wow</span>
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label" for="reaction5">
                                            <input class="form-check-input" type="radio" id="reaction5" name="reaction" value="sad">
                                            <span class="">Buồn</span>
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label" for="reaction6">
                                            <input class="form-check-input" type="radio" id="reaction6" name="reaction" value="angry">
                                            <span class="">Tức giận</span>
                                        </label>
                                    </div>

                                    <div class="mt-5" id="showicon"></div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-3">
                                    <label for="spd" class="form-label">Tốc độ</label>
                                </div>
                                <div class="col-9">
                                    <select name="speed" id="spd" class="form-control">
                                        <option value="slow"> Nhanh </option>
                                        <option value="fast"> Chậm </option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <input type="number" name="amount" id="amount" value="500" class="form-control">
                                    <div class="mt-5">
